...
public class PrimaryActivity2 extends AppCompatActivity {
...
//    Map<String, Object> mInfMap;
    ...
    private void showProgressDlg(String msg, Integer time) {
        ...
        if (null == m_ProgressDlg) {
            m_ProgressDlg = ProgressDialog.show(PrimaryActivity2.this, "", msg);
...
//                    sendCmd("ID");
    ...
    void initListView () {
        ...
        mInfAdapter = new ArrayAdapter<String>(PrimaryActivity2.this, R.layout.listview_item, R.id.textViewCmd, mInfList);
...
//                    int dtcNumber  = Integer.valueOf(content.substring(0, 2),16);
                    ...
                    for (int i = 0; i < dtcNumber; ++i) {
                        Integer status = Integer.valueOf(content.substring(start + 5, start + 6), 16);
                        String sStatus = Integer.toString(status, 2);
                     //   String sStorageState = sStatus.substring(1, 3);
                        String sLamp = sStatus;
                        //当前信息
                        //dtc解析
...
//                tvInf.scrollTo(0, 0);
        ...
        btHistoryInf.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                bottomSheet.showWithSheetView(LayoutInflater.from(PrimaryActivity2.this).inflate(R.layout.window_history_list, bottomSheet, false));
                ...
                historyAdapter = new ArrayAdapter<String>(PrimaryActivity2.this, android.R.layout.simple_list_item_1, historyErrors);
    ...
    private void setDiagnoseView(View dialog) {
        ...
        txtD1.setText(getConfigData("V_D1", "10"));
        txtD2.setText(getConfigData("V_D2", "10"));
        txtD3.setText(getConfigData("V_D3", "10"));
        txtD4.setText(getConfigData("V_D4", "10"));
